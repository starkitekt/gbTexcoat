...
export const PRODUCT_LIST: ProductListItem[] = [
  ...
  { slug: 'uv-resist', code: 'GBT-UV', n: '02', title: 'UV-Resistant Coated & Laminated Fabric', subtitle: 'Coated & laminated fabric · 25-yr rated', d: 'Engineered to withstand harsh environments with superior weather protection and longevity for outdoor and architectural applications.', bullets: ['Outdoor membranes', 'Shade & shelter systems', 'Industrial covers'], img: '/images/balloon.jpg', specs: [{ k: 'UV rating', v: '25 yr' }, { k: 'Temp range', v: '–40 to +80 °C' }, { k: 'Areal weight', v: '620 gsm' }, { k: 'Spec', v: 'ISO 4892-3' }] },
  ...
  { slug: 'fuel', code: 'GBT-FX', n: '04', title: 'High-Performance Flexible Fuel Storage', subtitle: 'Collapsible fuel storage container', d: 'Durable, lightweight, leak-proof fuel storage containers engineered for flexibility, high capacity, and extreme environmental conditions.', bullets: ['Field fuel storage', 'Defence operations', 'Emergency fuel transport'], img: '/images/fuel.jpg', specs: [{ k: 'Capacity range', v: '500 – 10,000 L' }, { k: 'Fluids', v: 'JP-8, Jet A-1, Diesel' }, { k: 'Compliance', v: 'STANAG 4775' }, { k: 'Empty weight', v: '< 3% capacity' }] },
];
