...
export const PRODUCTS: Record<string, Product> = {
  ...
  fuel: {
    ...
    applications: [
      { t: 'High-Performance Fuel Bladder', d: 'Built for industrial and military use — unmatched durability and easy transport for large-scale fuel storage needs.', img: '/images/fuel_bladder.jpg' },
